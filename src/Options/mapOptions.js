...
const mapOptions = {
  ...
  subtitle: {
    text:
      "Worldwise totalcases, current infected counts and total deaths till now.",
  },
  mapNavigation: {
    enabled: true,
    buttonOptions: {
  ...
  tooltip: {
    pointFormat:
      '{point.name}: {point.value}<br><span style="color:gray;font-size:9px">Click for detail</span>',
  },
  series: [
    {
